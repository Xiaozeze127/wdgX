    ...
    res.on('end', () => {
        try {
            ...
            if (versionn > version) {
                ...
                if (parsedData[versionn]) {
                    console.log(versionn + 'This is a version that must be updated and is helping you install the update')
                    exec('npm i wdgx -g', function (err, stdout, stderr) {
                        if (err) {
                            console.log(err)
                        } else {
                            console.log(stdout);
